...
// import 'package:findeals/models/category_update.dart';
...
class TransactionProvider with ChangeNotifier {
  ...
  Future<void> loadTransactions() async {
    ...
    //CategoryUpdater cat_updater=CategoryUpdater();
    ...
    try {
      ...
      if (newSms.isNotEmpty) {
        ...
        //cat_updater.updateUncategorizedTransactions; //update category
